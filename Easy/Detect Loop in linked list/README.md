<h2><a href="https://www.geeksforgeeks.org/problems/detect-loop-in-linked-list/1?utm_source=youtube&utm_medium=courseteam_practice_desc&utm_campaign=sde_sheet_anvita">Detect Loop in linked list</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a linked list of <strong>N</strong> nodes. The task is to check if the&nbsp;linked list has a loop. Linked list can contain&nbsp;self loop.</span></p>
